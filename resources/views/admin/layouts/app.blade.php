...
<head>
    ...
    <title>@yield('title', __('messages.dashboard')) — Admin · GTA</title>
...
<body>
    ...
    <script src="{{ asset('assets/shared/js/panel.js') }}?v={{ @filemtime(base_path('assets/shared/js/panel.js')) }}"></script>
