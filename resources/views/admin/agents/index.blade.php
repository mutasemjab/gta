                    ...
                    <tbody>
                        @forelse($agents as $agent)
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/uploads/'.$agent->logo) }}" alt=""></td>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('admin.agents.edit', $agent->id) }}" class="btn-icon-sm btn-edit"
                                        ...
                                        <form action="{{ route('admin.agents.destroy', $agent->id) }}" method="POST"
                                            ...
                                            @csrf @method('DELETE')
                                            <button type="submit" class="btn-icon-sm btn-delete" title="حذف"><i
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-4">لا يوجد وكلاء</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
